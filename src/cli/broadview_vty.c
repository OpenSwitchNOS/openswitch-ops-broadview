...
{
    /* ops-broadview doesn't have any context level cli commands.
     * To load ops-broadview cli shared libraries at runtime,this function required.
     */
